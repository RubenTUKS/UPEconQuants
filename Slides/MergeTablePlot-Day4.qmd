...
- Google Scholar: my [profile](https://scholar.google.com/citations?user=aQuqTmcAAAAJ&hl=en)
...
- Basic idea: we want to combine data from numerous sources
- To do so: we must always have some sort of common *identifier*
    - Country and year
    - Survey identifier
    - Administrative unit
...
- We will use the LCS
- It contains information across numerous files
    - Persons
    - Households
    - Assets
    - Expenditures
...
- But, we can combine in most any way we want
...
- I have shown many simple tables this semester
- What is a table?
...
- In practice, tables should focus on a particular set of information and be clear
    - Focus reader attention
    - There should be no confusion
- Reducing confusion means clear variable labels, column headings, and relevant notes to allow the reader to understand what is presented without having to read the entire text!
- In what follows, I do not really do all that is necessary to clarify all details... Going forward, we will do more
...
- It must convey information 
    - Clearly
    - Effectively
    - Be entirely readable and contained
- Recall: a picture is supposed to be *worth a thousand words*
- So, use wisely
...
- How might we display qualitative information?
- Often, that is in words
- We see it in the news, in SARB reports and even speeches
- That wording conveys information, but what?
- Below, we will look at the words I have used in publication titles...
- Maybe, we can learn a bit about me that way, maybe not.
